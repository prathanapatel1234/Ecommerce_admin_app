...
@section('breadcrum')
<h1 class="page-title">Create Testimonial</h1>
<ol class="breadcrumb">
...
<div class="app-content">
    <div class="side-app">
        ...
        <!--  Start Content -->
    <form id="submitForm" class="row"  method="post" action="{{route('testimonial-store')}}">
        {{csrf_field()}}
        <!-- COL END -->
							<div class="col-lg-12">
								<div class="card">
									...
									<div class="card-body">
                                        ...
                                        <div class="form-group">
											...
											<input maxlength="20" type="text" class="form-control" name="heading" id="heading" placeholder="Heading..">
										</div>

										<div class="form-group">
											<label class="form-label">Title *</label>
											<input type="text" class="form-control" name="title" maxlength="27" id="title" placeholder="Title..">
										</div>

                                        <div class="form-group">
                                            <label  for="value"><b>Description</b></label>
                                                <textarea maxlength="55" class="form-control " name="desc" id="desc"></textarea>
                                        </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status){
                        ...
                        successMsg('Create Testimonial', data.msg, btn);
                        $('#submitForm')[0].reset();
                        ...
                        errorMsg('Create Testimonial','Input error');
                    }
                    buttonLoading('reset', $this);

                },
                error: function() {
                    errorMsg('Create Testimonial', 'There has been an error, please alert us immediately');
                    buttonLoading('reset', $this);
                }
