        ...
        <!-- COL END -->
							<div class="col-lg-12">
								<div class="card">
									...
									<div class="card-body">
                                    <form id="submitForm"  method="post" action="{{route('blog-store')}}">
                                    {{csrf_field()}}
                                    <div class="row">
										<div class="form-group col-sm-12 col-lg-12 col-md-12 col-12">
											<label class="form-label">Title *</label>
											<input onblur="convertToSlug(this)" type="text" class="form-control" name="title" id="title">
                                        </div>

                                        <div class="form-group col-sm-12 col-lg-12 col-md-12 col-12">
											<label class="form-label">Slug </label>
											<input type="text" readonly="readonly" class="form-control" name="slug" id="slug">
                                        </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status){
                        ...
                        successMsg('Create Blog', data.msg, btn);
                        $('#submitForm')[0].reset();
						...
						errorMsg('Create Blog', 'Input Error');
                    }
                    buttonLoading('reset', $this);

                },
                error: function() {
                    errorMsg('Create Blog', 'There has been an error, please alert us immediately');
                    buttonLoading('reset', $this);
                }
