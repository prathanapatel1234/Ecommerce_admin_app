    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                <a href="{{route('sub-category-page',['category'=>$title, 'subcategory'=>$val->title])}}" class="img-prod"><img class="img-fluid" src="{{url('/public/'.$val->image)}}" alt="{{$val->product_name}}">
                        {{-- <span class="status">30%</span> --}}
                        <div class="overlay"></div>
                    </a>
                    <div class="text py-3 pb-4 px-3 text-center">
                        <h3><a href="{{route('sub-category-page',['category'=>$title, 'subcategory'=>$val->title])}}">{{$val->title}}</a></h3>
                        {{-- <div class="d-flex">
                            <div class="pricing">
